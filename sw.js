...
const CACHE_NAME = 'civicsetu-v10';
...
const PRECACHE_URLS = [
  ...
  '/js/geo-cluster.js?v=24',
  '/js/vendor/tf.min.js?v=24',
  '/js/vendor/mobilenet.min.js?v=24',
  '/js/ml.js?v=24',
  '/js/app.js?v=24',
  '/js/citizen.js?v=24',
  '/js/authority.js?v=24',
  '/js/portfolio.js?v=24',
  '/js/teambuilder.js?v=24',
  '/js/investor.js?v=24',
  '/js/policy.js?v=24',
  '/js/badges.js?v=24',
  '/js/chatbot.js?v=24',
  '/js/supabase-client.js?v=24',
];
