...
const CACHE_NAME = 'civicsetu-v14';
...
const PRECACHE_URLS = [
  ...
  '/js/geo-cluster.js?v=28',
  '/js/vendor/tf.min.js?v=28',
  '/js/vendor/mobilenet.min.js?v=28',
  '/js/ml.js?v=28',
  '/js/app.js?v=28',
  '/js/citizen.js?v=28',
  '/js/authority.js?v=28',
  '/js/portfolio.js?v=28',
  '/js/teambuilder.js?v=28',
  '/js/investor.js?v=28',
  '/js/policy.js?v=28',
  '/js/badges.js?v=28',
  '/js/chatbot.js?v=28',
  '/js/supabase-client.js?v=28',
];
